...
if process_url_clicked:
    ...
    # Check if there are embeddings before attempting to create the index
    if embeddings:
        ...
        main_placeholder.text("Error: No embeddings available.")
    ...
    if os.path.exists(file_path):
        with open(file_path, "rb") as f:
            ...
            if sources and isinstance(sources, list):
                ...
                st.subheader("Sources not available.")
